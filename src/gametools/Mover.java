    ...
    public void move() {
        ...
        if (numberOfDirections == Directions.TWO_DIRECTIONS
            ...
            if (source.direction == Directions.UP) {
                ...
                moveDown();
            } else if (source.direction == Directions.LEFT) {
                moveLeft();
            ...
            if (source.direction == Directions.NORTH) {
                moveNorth();
            } else if (source.direction == Directions.NORTH_NORTH_EAST) {
                moveNorthNorthEast();
            } else if (source.direction == Directions.NORTH_EAST) {
                moveNorthEast();
            } else if (source.direction == Directions.EAST_NORTH_EAST) {
                moveEastNorthEast();
            } else if (source.direction == Directions.EAST) {
                moveEast();
            } else if (source.direction == Directions.EAST_SOUTH_EAST) {
                moveEastSouthEast();
            } else if (source.direction == Directions.SOUTH_EAST) {
                moveSouthEast();
            } else if (source.direction == Directions.SOUTH_SOUTH_EAST) {
                moveSouthSouthEast();
            } else if (source.direction == Directions.SOUTH) {
                moveSouth();
            } else if (source.direction == Directions.SOUTH_SOUTH_WEST) {
                moveSouthSouthWest();
            } else if (source.direction == Directions.SOUTH_WEST) {
                moveSouthWest();
            } else if (source.direction == Directions.WEST_SOUTH_WEST) {
                moveWestSouthWest();
            } else if (source.direction == Directions.WEST) {
                moveWest();
            } else if (source.direction == Directions.WEST_NORTH_WEST) {
                moveWestNorthWest();
            } else if (source.direction == Directions.NORTH_WEST) {
                moveNorthWest();
            } else if (source.direction == Directions.NORTH_NORTH_WEST) {
                moveNorthNorthWest();
            }
        }
    }
